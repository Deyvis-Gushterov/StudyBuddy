    ...
    public partial class InitialPostgresCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    FirstName = table.Column<string>(type: "character varying(90)", maxLength: 90, nullable: false),
                    LastName = table.Column<string>(type: "character varying(90)", maxLength: 90, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFollowers", x => new { x.ApplicationUserId, x.FollowersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BriefExplanation = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ApplicationUserId = table.Column<string>(type: "text", nullable: false),
                    SavedNotesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSavedNotes", x => new { x.ApplicationUserId, x.SavedNotesId });
                    table.ForeignKey(
                        name: "FK_UserSavedNotes_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSavedNotes_Notes_SavedNotesId",
                        column: x => x.SavedNotesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reason = table.Column<string>(type: "character varying(90)", maxLength: 90, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSavedNotes_SavedNotesId",
                table: "UserSavedNotes",
                column: "SavedNotesId");
        }
